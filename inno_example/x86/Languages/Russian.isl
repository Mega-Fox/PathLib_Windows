...
UninstallAppRunningError=Программа удаления обнаружила запущенный экземпляр %1.%n%nПожалуйста, закройте все экземпляры приложения, затем нажмите «OK», чтобы продолжить, или «Отмена», чтобы выйти.
...
; *** "Welcome" wizard page
WelcomeLabel1=Вас приветствует программа установки [name]
...
UninstallUnsupportedVer=Файл протокола для удаления "%1" не распознан данной версией программы удаления. Удаление невозможно
...
UninstallOnlyOnWin64=Данную программу возможно удалить только в среде 64-битной Windows.
...
UninstallDataCorrupted=Файл "%1" поврежден. Удаление невозможно
